...
const routes: Routes = [
  ...
  { path: 'cadastro-suprimentos/:id_suprimento', component: CadastroSuprimentosComponent, canActivate: [AuthGuard] },
  ...
  { path: 'cadastro-suprimento/:id', component: ConsultaSuprimentosComponent, canActivate: [AuthGuard]  },
